      ...
      <div className="pt-20">
        ...
        <section className="relative min-h-[85vh] flex flex-col items-center justify-center text-center px-6">
          ...
          <div className="flex flex-col sm:flex-row gap-5">
            <button className="px-10 py-4 bg-gradient-to-r from-red-600 to-orange-600 rounded-xl font-bold text-lg hover:scale-105 transition-all shadow-xl shadow-red-600/20 flex items-center gap-2">
              Raise a Complaint <ArrowRight className="w-5 h-5" />
            </button>
            <button className="px-10 py-4 border border-white/10 rounded-xl font-bold text-lg hover:bg-white/5 transition-all flex items-center gap-2">
